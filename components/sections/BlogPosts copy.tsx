  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
      <div className="md:col-span-3 w-full h-full flex flex-col items-start justify-center p-6 md:p-12 order-2 md:order-1">
        ...
        <h2 className='mt-[10px] mb-[1rem] text-[28px] md:text-[36px] font-bold '>Porque necesitas hacer el Bootcamp</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mt-12">
        ...
        >
              ...
              <h2 className='mt-[10px] mb-[1rem] text-[28px] md:text-[36px] font-bold '>Conseguir un trabajo
remoto y ganar bien</h2>
          <p
